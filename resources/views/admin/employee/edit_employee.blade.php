            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="startdate" id="startdate" placeholder="dd-mm-yyyy" min="01/01/1980" max="31/12/2030" value="{{$employee->StartDate}}">
                    </div>
                    <div class="form-group">
                        <label class="font-weight-semibold" for="startdate">Ngày nghỉ</label>
                        <input type="date" class="form-control" name="enddate" id="startdate" placeholder="dd-mm-yyyy" min="01/01/1980" max="31/12/2030" value="{{$employee->EndDate}}">
                    </div>
                    <div class="form-group">
