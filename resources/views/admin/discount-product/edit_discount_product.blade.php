...
<form action="{{URL::to('/update-discount-product/'.$product->DisID)}}" method="post">
    {{csrf_field()}}
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="discount_value" id="discount_value" step=".05" placeholder="...%" min="0.05" max="0.7" value="{{$product->Value}}" >
                    </div>
                    <div class="form-group">
                        <label class="font-weight-semibold" for="startdate">Ngày bắt đầu</label>
                        <input type="datetime-local" class="form-control" name="startdate" id="startdate" placeholder="d/m/y H:m:s" value="{{$product->StartDate}}" required>
                    </div>
                    <div class="form-group">
                        <label class="font-weight-semibold" for="enddate">Ngày kết thúc</label>
                        <input type="datetime-local" class="form-control" name="enddate" id="startdate" placeholder="d/m/y H:m:s" value="{{$product->EndDate}}" required>
                    </div>
                </div>
                <div class="m-b-15">
