...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/client/BuyAndPayAssets/delivery/deliveryInfo.css')}}">
...
<body>
        ...
        <div class="content">
            ...
            <div class="content__description">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <span><b>Chọn địa chỉ có sẵn bên dưới:</b></span>
                        </div>
                    </div>
                    <div class="row">
                        <button type="button" class="content__login-button">
                            Đăng nhập hoặc Tạo tài khoản
                            <span class="content__login-brand1">Brili</span>
                            <span class="content__login-brand2">Fresh</span>
                        </button>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <span><b>Chọn địa chỉ khác:</b></span>
                        </div>
                    </div>
                    <div class="row">
    ...
    <script type="text/javascript" src="{{asset('public/client/BuyAndPayAssets/delivery/deliveryInfo.js')}}"></script>
</body>
