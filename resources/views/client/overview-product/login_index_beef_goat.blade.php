                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <div class="logo-name ms-auto my-lg-2">
                        <a class="navbar-brand" href="#">
                            <img id="logo" src="{{asset('public/client/OverviewProductAssets/images/newlogo.png')}}"></img>
                    ...
                    <div class="navbar-nav me-auto mb-lg-0 align-item-center p-1 nav-right">
                        <div class="nav-item col-11 mt-1 d-flex justify-content-between align-item-center">
                            ...
                            <li class="header__navbar-avt nav-link active"><img src="~/OverviewProductAssets/images/newlogo.png" alt="" id="avartar_user"></li>
                        </div>
                    ...
                    <div class="list-products col-9 row d-flex">
                        <div class="product-item col-3">
                            <div class="product-item-img">
                                ...
                                <a class="nav-link" href="{{URL::to('/fish-&-meat/beef-&-goat/detail-beef-&-goat')}}">
        ...
        <div class="container-fluid container-footer">
            <div class="row brand-footer mt-2">
                ...
                <div class="logo-name-footer me-1 my-lg-2">
                    <a class="navbar-brand" href="#">
                        <img id="logo" src="{{asset('public/client/asset/image/d2bt_ofot_150607 10.png')}}" class="position-start"></img>
                            ...
                            <div class="col-md-3 col-lg-4 col-xl-4 mx-auto mb-0 title-footer">
                                ...
                                <p>
                                    <a href="#!" class="text-reset text-decoration-none  font-16">
                                        <i class="fab fa-facebook-f me-4"></i>Kết nối qua Facebook</a>
                                </p>
                                <p>
                                    <a href="#!" class="text-reset text-decoration-none  font-16">
                                        <i class="fab fa-instagram me-3"></i>
                                        Kết nối qua Instagram</a>
                                </p>
                                <p>
                                    <a href="#!" class="text-reset text-decoration-none  font-16">
                                        <i class="fab fa-tiktok me-4"></i>
                                        Kết nối qua Tiktok</a>
                                </p>
