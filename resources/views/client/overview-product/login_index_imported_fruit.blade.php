...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/client/OverviewProductAssets/Fruit/List_Main_Fruit.css')}}" />
...
<body>
    ...
    <div class="main container">
        ...
        <div class="container">
            <div class="sliderr">
                <img src="~/OverviewProductAssets/images/slider.png" alt="" class="slider-img" />
            </div>
            <div class="location-bar" style="--bs-breadcrumb-divider: '>'" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="">Sản phẩm</a></li>
                    <li class="breadcrumb-item"><a href="">Hoa quả 4 mùa</a></li>
                    ...
                    <div class="list-products col-9 row d-flex">
                        <div class="product-item col-3">
                            <div class="product-item-img">
                                <a class="nav-link" href="{{URL::to('/fruits/imported-fruits/detail-imported-fruits')}}">
                                    <img src="{{asset('public/client/ImageProduct/is_avtx0xejubr.png')}}" alt="" class="product-item-img-child" />
                                </a>
                            </div>
