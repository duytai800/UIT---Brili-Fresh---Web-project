...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/client/Overviewproductassets/vegetable/detailvegetable.css')}}">
...
<body>
            ...
            <div class="container-fluid ms-5">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Kiwi (Nhập khẩu)</li>
                    </ol>
                </nav>
            </div>
        </nav>
            ...
            <div class="d-flex justify-content-between align-item-center mx-auto">
                ...
                <div class="product-info justify-content-center align-items-center">
                    ...
                    <div class="description mt-3 mb-auto">
                        ...
                        <p class="description-body">
                            Những con heo lấy thịt thông thường thường được nuôi bằng ngũ cốc, nhưng heo iberico được nuôi với chế độ ăn uống chất lượng hàng đầu với thức ăn chính là hạt dẻ sồi. Mỡ trong thịt heo có chứa axit béo không bão hòa Oleic.
        ...
        <div class="container-fluid container-footer">
            <div class="row brand-footer mt-2">
                ...
                <div class="logo-name-footer me-1 my-lg-2">
                    <a class="navbar-brand" href="#">
                        <img id="logo" src="./images/newlogo.png" class="position-start"></img>
    ...
    <script src="{{asset('public/client/Overviewproductassets/vegetable/detailvegetable.js')}}"></script>
</body>
